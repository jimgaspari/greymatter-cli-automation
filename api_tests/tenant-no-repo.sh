...
TOKEN="devtoken"
REPO_URL="https://gitea.home.pogotech.net/jimgaspari/auto-cli-tenant-test.git"
NAMESPACE="auto-tenant"
BASE_BRANCH="main"
API_KEY=$GITEA_TOKEN

curl -k -X DELETE "https://gitea.home.pogotech.net/api/v1/repos/jimgaspari/auto-cli-tenant-test" \
